            ...
            <div class="col-md-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('admin/admins') ?>">Manage Admins</a></li>
                    ...
                    <form action="<?= site_url('admin/admins/update/' . $admin['id']) ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="password" name="password" 
                                   minlength="8">
                            <div class="form-text">Leave blank to keep current password. Must be at least 8 characters long if changed.</div>
                        </div>
